...
type SpecificCategoryCachedPageProps = {
  categoryId: string;
};

export function SpecificCategoryCachedPage({ categoryId }: SpecificCategoryCachedPageProps) {
  ...
  const category = useMemo(() => {
    ...
    const scopedLocalId = Number(categoryId.split("_").pop());
